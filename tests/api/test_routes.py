...
def test_ingest_package():
    ...
    with patch("src.api.routes.compute_package_rating") as mock_rate:
        mock_rate.return_value = PackageRating(
            ...
            reproducibility=1.0, reproducibility_latency=0, performance_claims=1.0, performance_claims_latency=0, dataset_and_code_score=1.0, dataset_and_code_score_latency=0, dataset_quality=1.0, dataset_quality_latency=0, size_score=1.0, size_score_latency=0
        )
...
def test_rate_package():
    ...
    with patch("src.api.routes.compute_package_rating") as mock_rate:
        mock_rate.return_value = PackageRating(
            ...
            reproducibility=0.5, reproducibility_latency=10, performance_claims=0.5, performance_claims_latency=10, dataset_and_code_score=0.5, dataset_and_code_score_latency=10, dataset_quality=0.5, dataset_quality_latency=10, size_score=0.5, size_score_latency=10
        )
...
def test_get_packages_empty():
    ...
    with patch("src.api.routes.compute_package_rating") as mock_rate:
        mock_rate.return_value = PackageRating(
            ...
            tree_score=1.0, tree_score_latency=0, reproducibility=1.0, reproducibility_latency=0, performance_claims=1.0, performance_claims_latency=0, dataset_and_code_score=1.0, dataset_and_code_score_latency=0, dataset_quality=1.0, dataset_quality_latency=0, size_score=1.0, size_score_latency=0
        )
        for i in range(15):
...
def test_search_by_regex():
    ...
    with patch("src.api.routes.compute_package_rating") as mock_rate:
         mock_rate.return_value = PackageRating(
            ...
            tree_score=0.5, tree_score_latency=0, reproducibility=0.5, reproducibility_latency=0, performance_claims=0.5, performance_claims_latency=0, dataset_and_code_score=0.5, dataset_and_code_score_latency=0, dataset_quality=0.5, dataset_quality_latency=0, size_score=0.5, size_score_latency=0
         )
